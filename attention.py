...
class SelfAttention(Layer):
    ...
    def build(self, input_shape):
        ...
        self.attention.add(keras.layers.Dense(dimensions,name="-----dense1",
                                              input_shape=(
        ...
        self.attention.add(keras.layers.Dense(1,name="-----dense2",
                                              kernel_initializer=self.kernel_initializer,
                                              kernel_regularizer=self.kernel_regularizer,
                                              kernel_constraint=self.kernel_constraint))
        
		# make an attention vector
        self.attention.add(keras.layers.Flatten(name="flaaatten"))
        self.attention.add(keras.layers.Activation('softmax',name="soooooft"))
        # repeat this time step weighting for each dimensions
        self.attention.add(keras.layers.RepeatVector(dimensions,name="rerererepeat"))

        # reshape to be (time_steps, dimensions)
        self.attention.add(keras.layers.Permute([2, 1], name="peeeermute"))
